...
namespace ConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
             ...
             * DONE - The vehicle class shall have one int and twoe string properties Year, Make, and Model
            ...
            */
            ...
            var motorcycle = new Motorcycle() { HasSideCar = true, Make = "Harley Davidson", Model = "Roadster", Year = 2016 };

            //Did not list HasTrunk for sedan since the sedan does have a trunk = true and the default is set to true under the Car class.
            Vehicle sedan = new Car() { Make = "Dodge", Model = "Dakota", Year = 1986 };
            Vehicle sportCar = new Car() { HasTrunk = false, Make = "Porche", Model = "911", Year = 2019 };
